...
<details markdown="1">
<summary markdown="1">Could not resolve a dependency (e.g. `firebase-bom`)</summary>
...
<details markdown="1">
<summary markdown="1">`[Dagger/MissingBinding]`</summary>
...
<details markdown="1">
<summary markdown="1">Duplicate class errors (e.g. `kotlin.collections.CollectionsKt`)</summary>
...
<details markdown="1">
<summary markdown="1">`FirebaseApp is not initialized`</summary>
...
<details markdown="1">
<summary markdown="1">`Hilt entry point not found` on startup</summary>
...
<details markdown="1">
<summary markdown="1">`updateStateWith`/`updateWith` won't compile</summary>
...
<details markdown="1">
<summary markdown="1">Google Sign-In fails with `ApiException: 10`</summary>
...
<details markdown="1">
<summary markdown="1">`CredentialManager is not available`</summary>
...
<details markdown="1">
<summary markdown="1">Firestore `PERMISSION_DENIED`</summary>
...
<details markdown="1">
<summary markdown="1">Sync never runs, `isSyncing` never emits `true`</summary>
...
<details markdown="1">
<summary markdown="1">Spotless license-header or ktlint failures, incl. CI `spotlessCheck`</summary>
...
<details markdown="1">
<summary markdown="1">`Room cannot verify the data integrity` after a schema change</summary>
...
<details markdown="1">
<summary markdown="1">`OutOfMemoryError` loading images</summary>
